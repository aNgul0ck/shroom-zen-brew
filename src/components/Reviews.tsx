...
const Reviews = () => {
  ...
  const reviews = t("homepage.reviews.items", { returnObjects: true }) as ReviewCopy[];
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-10">
          <div>
            <p className="font-body text-xs font-medium text-foreground/50 uppercase tracking-[0.2em] mb-3">
              {t("homepage.reviews.eyebrow")}
            </p>
            <h2 className="ed-heading text-foreground leading-tight">
              {t("homepage.reviews.sectionTitle")}
            </h2>
          </div>
          <div className="flex items-center gap-2">
            ...
            <span className="font-display text-lg font-semibold text-foreground">{t("homepage.reviews.ratingValue")}</span>
            <span className="font-body text-xs text-foreground/50">{t("homepage.reviews.ratingNote")}</span>
          </div>
        </div>
