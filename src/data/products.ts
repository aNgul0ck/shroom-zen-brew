...
export const products: Product[] = [
  ...
  },
  {
    ...
    routine: [
      { time: "14:00", label: "Po kawie", description: "Trzęsawka po trzeciej kawie? L-teanina wygładza kofeinę, bez crashu." },
      { time: "17:00", label: "Po stresie", description: "Trudna rozmowa, deadline? Reset głowy w środku dnia — bez senności." },
      { time: "20:00", label: "Wieczorny reset", description: "Kolacja, książka, serial. Zwolnij obroty zamiast lampki wina." },
      { time: "23:00", label: "Spokojny sen", description: "Naturalna regeneracja. Budzisz się świeży, bez kaca." },
    ],
    ritualMeta: {
      bestFor: "Po kawie, po stresie, na wieczorny reset",
      instead: "Zamiast kolejnej kawy, lampki wina lub piwa",
      pairsWith: "Praca, joga, kolacja, czytanie, serial",
      avoid: "Tuż przed treningiem siłowym",
    },
    occasion: {
      eyebrow: "Daytime SOS · evening wind-down",
      headline: "Reset bez kaca",
      subtitle: "W ciągu dnia jako SOS po kawie i stresie. Wieczorem jako wyciszenie — bez alkoholu, bez senności następnego dnia.",
