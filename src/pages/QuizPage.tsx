...
const results: Record<string, Result> = {
  power: {
    ...
    slug: "shroom-power",
    title: "Dla aktywnych",
    description: "Twój dzienny rytuał. Soplówka jeżowata, żeń-szeń koreański, witamina C, cynk.",
  ...
  relax: {
    ...
    description: "Twój popołudniowy i wieczorny rytuał. L-teanina, chmiel, soplówka jeżowata. Bez alkoholu.",
